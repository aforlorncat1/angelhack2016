...
class RanksControllerTest < ActionController::TestCase
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post :create, rank: { leaderboard_id: @rank.leaderboard_id, nom_id: @rank.nom_id, position: @rank.position, votecount: @rank.votecount }
    end
  ...
  test "should update rank" do
    patch :update, id: @rank, rank: { leaderboard_id: @rank.leaderboard_id, nom_id: @rank.nom_id, position: @rank.position, votecount: @rank.votecount }
    assert_redirected_to rank_path(assigns(:rank))
  end
